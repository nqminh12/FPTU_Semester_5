...
public class AccountDAO {
    ...
    public boolean adminInsertAccount(String username, String password, String firstname, String lastname, String email, String phonenumber, String role_id) {
        String sql = "Insert into Account_he176151 values(?,?,?,?,?,?,?)";
        try {
            PreparedStatement ps = con.prepareStatement(sql);
            ps.setString(1, username);
    ...
    public boolean adminUpdateAccount(int id, String username, String password, String first_name, String last_name, String email, String phone_number, String role_id) {
    ...
    public static void main(String[] args) {
        ...
        boolean i =  a.INSTANCE.adminInsertAccount("admin", "123", "Phạm", "Phong", "Phong@123", "123456789", "0");
